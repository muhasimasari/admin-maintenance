...
$(function () {
  const tableElement = $(".datatables-divisions-table");
  ...
  if (tableElement.length) {
    const dataTable = tableElement.DataTable({
        ...
        },
        {
          ...
          render: (data, type, row) => `
            <div class="d-flex align-items-center">
              <a href="./edit-division.html?id=${data}" class="btn btn-primary btn-sm me-2">
      ...
      language: {
        ...
        search: "",
        searchPlaceholder: "Search Division name",
      },
      responsive: true,
    });
    ...
    $('.left').html(`
      ...
      <button class="btn btn-outline-secondary px-3"><i class="mdi mdi-download-outline me-1"></i>Download Division</button>
    `);

    // Append buttons to "right"
    $('.right').append(`
      <a href="javascript:void(0);" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#uploadModal"><i class="mdi mdi-upload-outline me-1"></i>Upload</a>
      <a href="./create-division.html" class="btn btn-primary"><i class="mdi mdi-plus me-1"></i>Add</a>
    `);
