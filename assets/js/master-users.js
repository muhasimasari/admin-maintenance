...
$(function () {
  const tableElement = $(".datatables-users-table");
  ...
  if (tableElement.length) {
        ...
        },
        {
          ...
          render: (data, type, row) => `
            <div class="d-flex align-items-center">
              <a href="./edit-user.html?id=${data}" class="btn btn-primary btn-sm me-2">
    ...
    $('.right').append(`
      <a href="./create-user.html" class="btn btn-primary w-100"><i class="mdi mdi-plus me-1"></i>Add</a>
    `);
