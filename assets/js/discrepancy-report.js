  ...
  function initComponent() {
    ...
    buttons.forEach(function (btn) {
      btn.addEventListener('click', function () {
        ...
        buttons.forEach(b => {
          b.classList.remove('active', 'btn-success', 'btn-warning', 'btn-warning-high', 'btn-danger');
...
function CtrlDiscrepancyReportAssignTo() {
  this.init = init
...
function CtrlDiscrepancyReportDetail() {
  this.init = init
