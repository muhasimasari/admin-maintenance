...
$(function () {
  const tableElement = $(".datatables-department-table");
  ...
  if (tableElement.length) {
        ...
        },
        {
          ...
          render: (data, type, row) => `
            <div class="d-flex align-items-center">
              <a href="./edit-department.html?id=${data}" class="btn btn-primary btn-sm me-2">
    ...
    $('.right').append(`
      ...
      <a href="./create-department.html" class="btn btn-primary"><i class="mdi mdi-plus me-1"></i>Add</a>
    `);
